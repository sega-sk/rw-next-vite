            ...
            <div className="contact-modal-form space-y-5">
              ...
              {formData.mainOption === 'rent' && (
                <div className="rental-period-section bg-yellow-50 rounded-xl p-4 border border-yellow-200">
                  ...
                  {/* Add Start Date field for rent_a_product */}
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full p-3 border-2 border-yellow-200 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 font-inter transition-all duration-200 mb-4"
                  />

                  {/* Add Duration field for rent_a_product */}
                  <label className="block text-sm font-semibold text-gray-700 mb-2 font-inter">
                  ...
                  <input
                    ...
                    className="w-full p-3 border-2 border-yellow-200 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 font-inter transition-all duration-200"
                  />
                </div>
              )}
