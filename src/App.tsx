      ...
      <ToastProvider>
        <FavoritesProvider>
          <Router>
            ...
            <Route path="/:productSlug/memorabilia" element={<MemorabiliaPage />} />
            <Route path="/:productSlug/memorabilia" element={<MemorabiliaPage />} />
            <Route path="/merchandise" element={<MerchandisePage />} />
            <Route path="/:productSlug/merchandise" element={<MerchandisePage />} />
            <Route path="/:productSlug/merchandise" element={<MerchandisePage />} />
            ...
            <Route path="/admin/users/add" element={
              <ProtectedRoute>
                <Layout title="Add User" breadcrumb={['Dashboard', 'Users', 'Add User']}><AddUserPage /></Layout>
              </ProtectedRoute>
            } />
